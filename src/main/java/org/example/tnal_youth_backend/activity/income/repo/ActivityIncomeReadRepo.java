package org.example.tnal_youth_backend.activity.income.repo;
...
@Mapper
public interface ActivityIncomeReadRepo {
    ...
    @Select("""
        ...
        """)
    List<ActivityIncomeMemberRowResponse> findRows(@Param("activityId") Long activityId);
}
